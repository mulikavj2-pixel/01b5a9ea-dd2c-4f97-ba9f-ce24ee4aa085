...
export const metadata: Metadata = {
  title: "Coffee Artisan - Specialty Coffee & Fresh Pastries",
  description: "Discover exceptional handcrafted coffee and fresh pastries at Coffee Artisan. Ethically sourced beans, expert baristas, and cozy atmosphere.",
  keywords: "specialty coffee, artisan coffee shop, espresso, latte, local coffee",
  metadataBase: new URL("https://coffeeartisan.com"),
  alternates: {
    canonical: "https://coffeeartisan.com"
  },
  openGraph: {
